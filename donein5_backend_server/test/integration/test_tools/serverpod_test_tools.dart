...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:donein5_backend_server/src/generated/member.dart' as _i5;
import 'package:donein5_backend_server/src/generated/user_recipe.dart' as _i6;
import 'package:donein5_backend_server/src/generated/greetings/greeting.dart'
    as _i7;
import 'package:donein5_backend_server/src/generated/protocol.dart';
import 'package:donein5_backend_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _UserRecipeEndpoint userRecipe;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    userRecipe = _UserRecipeEndpoint(
      endpoints,
      serializationManager,
    );
...
class _MemberEndpoint {
  ...
  _i3.Future<_i5.Member?> findByEmail(
    _i1.TestSessionBuilder sessionBuilder, {
    required String email,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<bool> addFavoriteFood(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'member',
            method: 'addFavoriteFood',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'member',
          methodName: 'addFavoriteFood',
          parameters: _i1.testObjectToJson({
            'email': email,
            'foodId': foodId,
          }),
  ...
  _i3.Future<bool> updateFoodStyle(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'member',
            method: 'updateFoodStyle',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'member',
          methodName: 'updateFoodStyle',
          parameters: _i1.testObjectToJson({
            'email': email,
            'foodStyle': foodStyle,
          }),
  ...
  _i3.Future<bool> updateSpicyHeat(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'member',
            method: 'updateSpicyHeat',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'member',
          methodName: 'updateSpicyHeat',
          parameters: _i1.testObjectToJson({
            'email': email,
            'spice': spice,
            'heat': heat,
  ...
  _i3.Future<bool> updateOnboardingPreferences(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'member',
            method: 'updateOnboardingPreferences',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
  ...
  _i3.Future<bool> addFavoriteFoodToFolder(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'member',
            method: 'addFavoriteFoodToFolder',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'member',
          methodName: 'addFavoriteFoodToFolder',
          parameters: _i1.testObjectToJson({
            'email': email,
            'foodId': foodId,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'member',
          methodName: 'createEmptyCollection',
          parameters: _i1.testObjectToJson({
            'email': email,
            'folderName': folderName,
          }),
...
class _UserRecipeEndpoint {
  ...
  _i3.Future<bool> saveRecipe(
    _i1.TestSessionBuilder sessionBuilder, {
    required _i6.UserRecipe recipe,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
  ...
  _i3.Future<List<_i6.UserRecipe>> getRecipesByMember(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'userRecipe',
            method: 'getRecipesByMember',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'userRecipe',
          methodName: 'getRecipesByMember',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i6.UserRecipe>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i6.UserRecipe?> getRecipeById(
    _i1.TestSessionBuilder sessionBuilder, {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'userRecipe',
          methodName: 'getRecipesByIds',
          parameters: _i1.testObjectToJson({'recipeIds': recipeIds}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
