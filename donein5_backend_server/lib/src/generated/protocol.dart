...
import 'recipe.dart' as _i7;
import 'user_recipe.dart' as _i8;
import 'package:donein5_backend_server/src/generated/user_recipe.dart' as _i9;
...
class Protocol extends _i1.SerializationManagerServer {
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'user_recipe_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'mongoId',
          columnType: _i2.ColumnType.text,
  ...
  T deserialize<T>(
    ...
    if (t == _i8.UserRecipe) {
      return _i8.UserRecipe.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i8.UserRecipe?>()) {
      return (data != null ? _i8.UserRecipe.fromJson(data) : null) as T;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i9.UserRecipe>) {
      return (data as List).map((e) => deserialize<_i9.UserRecipe>(e)).toList()
          as T;
    }
    try {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'UserRecipe') {
      return deserialize<_i8.UserRecipe>(data['data']);
    }
  ...
  @override
  String getModuleName() => 'donein5_backend';
